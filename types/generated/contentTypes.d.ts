...
export interface ApiJobsJobs extends Struct.CollectionTypeSchema {
  collectionName: 'job';
  info: {
    displayName: 'Jobs';
    pluralName: 'job';
  ...
  attributes: {
    ...
    job_requirements: Schema.Attribute.Blocks;
    key_responsibilities: Schema.Attribute.Blocks;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::jobs.jobs'> &
      Schema.Attribute.Private;
